    ...
    <>
      <tr>
        <td colSpan="9" className="my-100 border-spacing-y-7">
          <div className="w-full my-4 bg-opacity-60 z-[900]  justify-center items-center">
            <MyLoader />
          </div>
        </td>
      </tr>
...
function MyLoader(props) {
  ...
  const styles = {
    ...
    surroundSpinner: {
      borderRadius: 100,
      borderRight: `2px solid #D2691E`,
      width: 65,
      height: 65,
      borderColor: props.loaderColor ? props.loaderColor : "black",
  ...
  const myClasses = {
    ...
    mainContainer: null,
    // iconHolder:`rotate`,
    surroundSpinner: `animate-rotate`,
  };
