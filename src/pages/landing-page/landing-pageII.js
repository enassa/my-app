...
import votingScreen from "../../assets/images/votingScreen.png";
import resultsScreen from "../../assets/images/resultsScreen.png";
import testifierImg from "../../assets/images/euegne.jpg";
...
const metrics = [
  {
    id: 1,
    stat: "Life time Access",
    emphasis: "Ownership",
    rest: "is given to you and can be used by your organization forever",
  },
  {
    id: 2,
    stat: "Name the App",
    emphasis: "Domain name",
    rest: "will be purchased for your prefered name.",
  },
  {
    id: 3,
    stat: "Higher speed",
    emphasis: "Dedicated hosting",
    rest: "space will make your election faster.",
  },
  {
    id: 4,
    stat: "Affordability",
    emphasis: "One time cool payment",
    rest: "will take of the burden of paying for every election",
  },
];
const footerNavigation = {
  ...
  social: [
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/aenathanielgh/",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: "Twitter",
      href: "https://twitter.com/aenathaniel",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
...
export default function LandingPageII() {
  ...
  return (
    <div className="bg-white w-full">
            ...
            <div className="relative shadow-xl sm:overflow-hidden sm:rounded-2xl">
              ...
              <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                ...
                <p className="mx-auto mt-6 max-w-lg text-center text-xl text-indigo-200 sm:max-w-3xl">
                  The koinovote application takes care of the election in a
                  simple, smart and quick way. Results is live and can be
                  displayed on a large screen for all to see.
                </p>
        ...
        <div className="bg-gray-100">
          <div className="mx-auto max-w-7xl py-16 px-4 sm:px-6 lg:px-8">
            <p className="text-center text-base font-semibold text-gray-500">
              Trusted by Achimota senior high school and many others.
            </p>
            <div className="mt-6 flex md:grid flex-col items-center grid-cols-2 gap-8 md:grid-cols-6 lg:grid-cols-5">
              <div className="col-span-1 flex justify-center md:col-span-2 lg:col-span-1 items-center">
                ...
                <span
                  style={{ fontSize: "2rem" }}
                  className="text-[#9CA3AF] font-bold ml-2"
                >
                  Simple
                </span>
              </div>
                ...
                <div>
                  ...
                  <div className="mt-6">
                    <h2 className="text-3xl font-bold tracking-tight text-gray-900">
                      The voting screen is as simple as ...
                    </h2>
                    <p className="mt-4 text-lg text-gray-500">
                      We have made the voting screen simple enough for every
                      voter irrespecive of their level of computer literacy.
                      Once a vote is submited. The system prepares itself
                      without aid and awaits the next voter.
                    </p>
                    <div className="mt-6">
                      <a
                        href="#"
                  ...
                  <blockquote>
                    <div>
                      <p className="text-base text-gray-500">
                        &ldquo;I love the simplicity of the interface. Even
                        people will little to no computer knowledeg can easily
                        use it.&rdquo;
                      </p>
                    </div>
                    <footer className="mt-3">
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="text-base font-medium text-gray-700">
                          Mr.Eugene Nunoo, IT Cordinator of Achimota School.
                        </div>
                      </div>
                    </footer>
                  </blockquote>
            ...
            <div className="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8">
              <div className="mx-auto max-w-xl px-4 sm:px-6 lg:col-start-2 lg:mx-0 lg:max-w-none lg:py-32 lg:px-0">
                <div>
                  ...
                  <div className="mt-6">
                    <h2 className="text-3xl font-bold tracking-tight text-gray-900">
                      The results screen is live and keeps the suspense on.
                    </h2>
                    <p className="mt-4 text-lg text-gray-500">
                      Similar to the voting screen, this screen also remains in
                      the theme of simplicity. Additionally, it is secured with
                      a password created during the creation of the election. So
                      the decision to make the results accesible is in your
                      hands.
                    </p>
                    <div className="mt-6">
                      <a
              ...
              <div className="mt-12 sm:mt-16 lg:col-start-1 lg:mt-0">
                <div className="-ml-48 pr-4 sm:pr-6 md:-ml-16 lg:relative lg:m-0 lg:h-full lg:px-0">
                  <img
                    className="w-full transform ] rounded-xl shadow-xl ring-1 ring-black ring-opacity-5 lg:absolute lg:right-0 lg:h-full lg:w-auto lg:max-w-none"
                    src={resultsScreen}
          ...
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:max-w-7xl lg:px-8 xl:grid xl:grid-flow-col-dense xl:grid-cols-2 xl:gap-x-8">
            <div className="relative pt-12 pb-64 sm:pt-24 sm:pb-64 xl:col-start-1 xl:pb-24">
              ...
              <p className="mt-5 text-lg text-gray-300">
                Whiles many prefer to subscribe, we understand that perhaps you
                might want a customized version of the app for your
                organization. The magnitude of the changes and additions might
                cause a difference, but averagely, customization is completed in
                less than a week with the following benefits.
              </p>
      ...
      <footer className="bg-gray-50" aria-labelledby="footer-heading">
        ...
        <div className="mt-12 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between lg:mt-16 pb-5">
          ...
          <p className="mt-8 text-base text-gray-400 md:order-1 md:mt-0  px-5 md:px-5 md:flex ">
            <span className="flex justify-center">
              &copy;2022 KoinoSolutions <br className=" md:hidden" />{" "}
            </span>
            <span className="flex justify-center">
              {" "}
              &nbsp;All rights reserved.
