...
export default class FileUploader extends Component {
          ...
          >
            <div
              style={{
                ...
                background:
                  "linear-gradient(180deg, rgba(25,25,25,0) 68%, rgba(0,0,0,1) 100%)",
              }}
            >
              <div
                style={{
              ...
              >
                <Crop
                  onClick={() => this.editImage(index)}
                  alt="Crop"
                  className={styles["edit-icons"]}
  ...
  render() {
    ...
    return (
      <div
        onDrop={(e) => this.handleImagesDropped(e)}
        style={{
          display: "flex",
          position: "relative",
          overflow: "hidden",
      ...
      >
            ...
            >
              ...
              >
                <img
                  ...
                  src={URL.createObjectURL(this.state.editingImage)}
                  style={{
                    backgroundColor: "white",
                    position: "absolute",
                    overflow: "hidden",
          ...
          >
            <input
              ...
              accept={`file_extension|${
                field.accepted ? field.accepted : ".jpg, .png,.jpeg,.JPEG,.JPG"
              }`}
              type="file"
              id="files"
              name="files"
            ...
            <h4 style={{ color: "grey" }}>
              ...
              <b
                style={{ color: "#2B91FF", cursor: "pointer" }}
                onClick={() => inputNode.click()}
              >
                browse
              </b>
            </h4>
        ...
        {this.state.files.length ? (
          <div
            className={styles["uploader-images-container"]}
            style={{
              display: "flex",
              overflowX: "auto",
              marginTop: 40,
