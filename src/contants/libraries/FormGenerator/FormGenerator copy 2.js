      ...
      <div id={mod("main-form-container")} style={outerStyle}>
        {this.state.confirmation ? (
          <div
            ...
            className="w-full  items-center top-0 right-0 justify-center h-full bg-backdrop  fixed z-[500000]"
          >
            ...
            <div className="slide-up text-blue-500 m-w-[400px] w-[80%] relative items-center flex-col justify-center h-[200px] rounded-lg bg-white">
              <span style={{ fontFamily: fontFamily4, fontSize: 20 }}>
                Confirm form submission?
              </span>
              <span className=" w-full  bottom-0 right-0 justify-endabsolute pr-[20px] pb-[20px] ">
